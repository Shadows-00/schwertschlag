...
const voiceChannels = message.guild.channels.cache.filter(c => c.type === 'voice');
  ...
  let  çevrimiçi = message.guild.members.cache.filter(m => !m.user.bot && m.user.presence.status !== "offline").size
    const kobs  = new Discord.MessageEmbed()
        .setColor("#00a5ff")
        .setThumbnail(`https://cdn.discordapp.com/attachments/785746213982568508/785766492641558538/9_e_-_9_f.gif`)
        ...
        .setFooter(`Schwertschlag Code`, client.user.avatarURL())
